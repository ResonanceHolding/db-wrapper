...
class DB {
  ...
  /**
   * @name DbWrapperOptions
   * @property {boolean} debug log all queries
   */

  /**
   * Creates pool connection to the postgres db or client connection if client was provided
   * @param {*} pgConfig pg config of db you want to connect
   * @param {*} client if you want to create connection with existing client
   * @param {DbWrapperOptions} options options
   */
  constructor(pgConfig, client, options) {
